<template>
  <section>
    ...
    <div class="min-h-screen flex flex-col lg:flex-row font-sans bg-gray-50">
      <div
        class="lg:w-1/2 p-8 md:p-16 lg:p-24 flex flex-col justify-center order-2 lg:order-1"
      >
        <h1
        ...
        <p class="text-gray-600 text-xl md:text-2xl mb-8 max-w-lg">
          We're here to help! Fill out the form below with your details and
          issue. Our team will get back to you within 24 hours.
        </p>
      ...
      <div
        class="lg:w-1/2 bg-yellow-500 flex items-center justify-center p-8 md:p-16 order-1 lg:order-2"
      >
        <div
          class="bg-white rounded-xl shadow-2xl w-full max-w-xl p-8 md:p-10 text-center transform lg:scale-100"
        >
          ...
          <form @submit.prevent="handleSubmit">
            <div class="mb-5 text-left">
              ...
              <div class="relative">
                <i
                  class="fa-solid fa-user absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400"
                ></i>
                <input
            ...
            <div class="mb-5 text-left">
              ...
              <div class="relative">
                <i
                  class="fa-solid fa-envelope absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400"
                ></i>
                <input
            ...
            <div class="mb-5 text-left">
              <label class="block text-gray-700 font-semibold mb-2 text-sm"
                >Choose Your Issue</label
              >
              <div class="relative">
                <i
                  class="fa-solid fa-question absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400"
                ></i>
                <select
                ...
                >
                  ...
                  <option value="Wrong Product and Quality Issue">
                    Wrong Product / Quality
                  </option>
                  <option value="Delayed/Not Delivery">
                    Delayed / Not Delivered
                  </option>
                  <option value="Security Concerns">Security Concerns</option>
                  <option value="Technical Glitches">Technical Glitches</option>
                  <option value="Inappropriate Content or Behavior">
            ...
            <div class="mb-6 text-left">
              ...
              <div class="relative">
                <i
                  class="fa-solid fa-message absolute left-3 top-5 text-gray-400"
                ></i>
                <textarea
